...
find_package(JPEG)
option(tiff_jpeg "use libjpeg (required for JPEG compression)" ${JPEG_FOUND})
if (tiff_jpeg AND JPEG_FOUND)
    set(JPEG_SUPPORT TRUE)
endif()

# Old-jpeg
set(OJPEG_SUPPORT FALSE)
option(tiff_old-jpeg "support for Old JPEG compression (read-only)" ${JPEG_SUPPORT})
if (tiff_old-jpeg AND JPEG_SUPPORT)
...
if (NOT HAVE_JPEGTURBO_DUAL_MODE_8_12)
    ...
    option(tiff_jpeg12 "enable libjpeg 8/12-bit dual mode (requires separate 12-bit libjpeg build)" ${JPEG12_FOUND})
    if (tiff_jpeg12 AND JPEG12_FOUND)
